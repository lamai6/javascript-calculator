...
I have to create 5 projects in order to earn the Front End Development certification delivered by FreeCodeCamp. This repository is the fourth one : JavaScript Calculator. I used [my own React boilerplate](https://github.com/lamai6/react-app-starter) to start creating this application. You can [run it](https://github.com/lamai6/javascript-calculator#quick-start), [view the demo](https://lamai6.github.io/javascript-calculator) or [read the specifications](https://github.com/lamai6/javascript-calculator#specifications) the app must meet.
...
- start the app or go to the project [demo](https://lamai6.github.io/javascript-calculator)
